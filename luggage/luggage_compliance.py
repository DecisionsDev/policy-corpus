...
class LuggageCompliance:
    ...
    def validate_luggages(self, request):
...
def test1():
    ...
    compliance_request = LuggageComplianceRequest(travel_class="Business", age_category="adult", luggages=[bag1, bag2, bag3])

    result = policy.validate_luggages(compliance_request)
    print(result)
...
class TestLuggageCompliance(unittest.TestCase):
    ...
    def test_carry_on_exceeds_quantity(self):
        ...
        result = self.policy.validate_luggages(compliance_request)
