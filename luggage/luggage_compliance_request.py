...
class TestLuggagePolicy(unittest.TestCase):
    ...
    def test_1(self):
        bag1 = Luggage(storage="carry-on", weight=7.0, excess = False, dim={"height": 55.0, "width": 40.0, "depth": 23.0, "unit": "cm"})
        bag2 = Luggage(storage="checked", weight=25.0, excess=True, dim={"height": 70.0, "width": 50.0, "depth": 30.0, "unit": "cm"})
